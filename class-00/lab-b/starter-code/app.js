...
// I did tried changing this to an arrow function, it broke like you said it would, and then I changed it back so I coudl be allowed to moved forward with the rest o teh code challenges.
console.log(joe);
...
// The object that is being being referred to in that instance.
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// The entire window!
//
// 3. Explain why "this" is different when an arrow function is used.
// The arrow "this" did not take on the this of the object being referred to in our code, but rather the most basic object, the window we are working in.
