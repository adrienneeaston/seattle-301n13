...
function displayPics(){
  ...
  // Rando was assigned with const, and const is is only declaring that variable for that specific code block. The console.log throwing teh error was outside of that code block.
  console.log(viewed);
